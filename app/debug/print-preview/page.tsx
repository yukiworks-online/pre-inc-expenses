...
// import { PrintButton } from '@/app/settlements/PrintButton'; 
// Mocking PrintButton to avoid dependency issues if it's not exported correctly or has relative imports
const PrintButton = () => (
    <button
        onClick={() => window.print()}
        className="btn btn-primary px-8 py-3 rounded-full shadow-xl flex items-center gap-2 transform hover:scale-105 transition-all text-white font-bold tracking-wide bg-blue-600 hover:bg-blue-700"
    >
...
const expenses = [
    ...
    },
    {
        date: '2024/04/05',
        category: '消耗品費',
        vendor: 'Apple Store 銀座',
        description: 'MacBook Pro 14インチ M3 Pro (開発用端末として購入)',
        amount: 328800,
        payer: '山田 太郎'
    },
    {
        date: '2024/04/10',
        category: '会議費',
        vendor: 'スターバックスコーヒー 渋谷店',
        description: '共同創業者との事業計画打ち合わせ時の飲食代',
        amount: 1580,
        payer: '山田 太郎'
    },
    {
...
const payerName = expenses[0].payer;
const id = "SAMPLE-202404";
const dateStr = '2024年4月30日'; // Fixed date for consistency
